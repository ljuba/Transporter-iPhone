...
- (void)viewDidLoad {
	...
	if ([route.vehicle isEqual:@"cablecar"]) {
		...
		if ([route.title isEqualToString:@"PowllMason Cable"]) {
			routeTitle = @"Powell Mason Cable Car";
		}
		else if ([route.title isEqualToString:@"PowellHyde Cable"]) {
			routeTitle = @"Powell Hyde Cable Car";
		}
		else if ([route.title isEqualToString:@"Calif. Cable Car"]) {
			routeTitle = @"California Cable Car";
		}
		else {
	...
	else if ([route.vehicle isEqual:@"streetcar"]) {
		self.title = 	[NSString stringWithFormat:@"%@ Street Car", route.tag];
	}
	else if ([route.vehicle isEqual:@"metro"]) {
		self.title = 	[NSString stringWithFormat:@"%@ Metro", route.tag];
	}
	else if ([route.vehicle isEqual:@"bus"]) {
		self.title = [NSString stringWithFormat:@"%@ Bus", route.tag];
	}
