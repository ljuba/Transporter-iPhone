...
- (void)setBackgroundWithStopName:(NSString *)name agencyShortTitle:(NSString *)agencyShortTitle {
	...
	if ([agencyShortTitle isEqual:@"bart"]) {
		backgroundImage = [[UIImage imageNamed:@"fav-bart-stop-background.png"] retain];
	}
	else if ([agencyShortTitle isEqual:@"sf-muni"]) {
		backgroundImage = [[UIImage imageNamed:@"fav-muni-stop-background.png"] retain];
	}
	else if ([agencyShortTitle isEqual:@"actransit"]) {
		backgroundImage = [[UIImage imageNamed:@"fav-actransit-stop-background.png"] retain];
	}
